...
from lab import  lab_map, lab_map_2, lab_map_3, lab_map_4, draw_lab, Cloud, Rain, Butterfly, Flower, find_spawn_point
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                exit_row, exit_col = 13, 15
                player_row = (player2.rect.centery - OFFSET_Y) // CELL_SIZE
                player_col = (player2.rect.centerx - OFFSET_X) // CELL_SIZE
                if (player_row, player_col) == (exit_row, exit_col):
                    show_level_complete_window(3)
                    return
        pygame.display.update()
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                exit_row, exit_col = 13, 15
                player_row = (player3.rect.centery - OFFSET_Y) // CELL_SIZE
                player_col = (player3.rect.centerx - OFFSET_X) // CELL_SIZE
                if (player_row, player_col) == (exit_row, exit_col):
                    show_level_complete_window(3)
                    return
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                exit_row, exit_col = 13, 15
                player_row = (player4.rect.centery - OFFSET_Y) // CELL_SIZE
                player_col = (player4.rect.centerx - OFFSET_X) // CELL_SIZE
                if (player_row, player_col) == (exit_row, exit_col):
                    show_level_complete_window(4)
                    return
        pygame.display.update()
